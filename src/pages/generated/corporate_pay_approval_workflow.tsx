        ...
        <>
          ...
          <motion.div
            ...
            className={cn(
              ...
              "bottom-2 left-2 right-2 top-2 rounded-[28px]", // Reduced top offset
...
export default function CorporatePayApprovalWorkflowBuilderV2() {
  ...
  const reorderStage = (id: string, newIndex: number) => {
    if (!selectedFlow) return;
    const currentIdx = selectedFlow.stages.findIndex((s) => s.id === id);
    if (currentIdx < 0) return;

    setSelectedFlowPatch((f) => {
      const stages = [...f.stages];
      const [removed] = stages.splice(currentIdx, 1);
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                a.ooo ? "border-emerald-300 bg-emerald-200" : "border-slate-200 bg-white"
                              )}
                                ...
                                <div className="min-w-0">
                                  ...
                                  <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <div className="relative">
                                      <select
                                        value={idx}
                                        onChange={(e) => reorderStage(s.id, Number(e.target.value))}
                                        className="appearance-none rounded-2xl border border-slate-200 bg-white py-2 pl-3 pr-8 text-xs font-semibold text-slate-700 outline-none hover:bg-slate-50 focus:ring-2 focus:ring-emerald-100"
                                      >
                                        {selectedFlow.stages.map((_, i) => (
