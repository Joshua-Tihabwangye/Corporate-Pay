        ...
        {isOpen && rect && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 8, scale: 0.98 }}
              transition={{ duration: 0.16 }}
              className="fixed z-50 w-56 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_10px_38px_-10px_rgba(22,23,24,0.35),0_10px_20px_-15px_rgba(22,23,24,0.2)]"
              style={{ top, right }}
            >
              ...
              <div className="flex items-center justify-between gap-3 px-4 py-3 md:px-5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative hidden md:flex">
                    <button
                      className="flex items-center gap-2 rounded-2xl border border-white/30 bg-white/20 px-3 py-2 text-sm font-semibold text-white shadow-sm backdrop-blur hover:bg-white/30"
                      onClick={() => {
