...
export default function CorporatePayCorporateTravelSchedulingV2() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "radial-gradient(90% 60% at 50% 0%, rgba(3,205,140,0.18), rgba(255,255,255,0))" }}>
      ...
      <Modal
        open={bulkOpen}
        title="Bulk travel plan"
        subtitle="Premium: schedule many rides on behalf of employees."
        onClose={() => setBulkOpen(false)}
        actions={[{ label: "Create", onClick: runBulkBooking }]}
        footer={
          <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-between">
      ...
      <Modal
        open={vipReqOpen}
        title="Request VIP exception"
        subtitle="Premium: allow luxury rides or after-hours travel through approvals."
